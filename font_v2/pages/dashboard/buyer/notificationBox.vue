                                ...
                                <tbody class="t-body">
                                    ...
                                    <tr v-for="(order, index) in sellerMsgData" :key="index">
                                        ...
                                        <td class="vam"><nuxt-link class="btn text-white btn-primary"
                                                to="/dashboard/buyer/chatbox">Reply</nuxt-link></td>
                                    </tr>
...
const formatDate = (date) => {
    const options = {
        ...
        month: 'short', // Abbreviated month (e.g., Jan, Jun)
        year: 'numeric',
        hour: 'numeric',
        minute: 'numeric',
    ...
    // Rearrange and remove the default commas
    const parts = formattedDate.split(','); // Split the default format
    const [monthDay, year, time] = parts; // Extract parts
    const [month, day] = monthDay.trim().split(' '); // Separate day and month

    return `${day} ${month} ${year.trim()}, ${time.trim()}`; // Rearrange and join
};
