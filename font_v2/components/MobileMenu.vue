          ...
          <div class="mobile-menu">
            <div class="header bdrb1">
              <div class="menu_and_widgets">
                ...
                >
                  <nuxt-link class="mobile_logo" to="/"><img src="/images/header-logo.png" alt="" style="width: 150px;"/></nuxt-link>
                  <div class="right-side text-end">
                    <nuxt-link class="" to="/sign-in">Login</nuxt-link>
                    <a class="menubar ml30" href="#menu" @click="toggleMenu"
...
const loading = ref(true); // Initialize the loading state
