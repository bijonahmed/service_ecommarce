<template>
            ...
            <div class="container">
              <div class="row bb-white-light pb10 mb60">
                <div class="col-md-7">
                  ...
                  >
                    <a class="fz17 fw500 text-white mr15-md mr30" href="#"
                      >Terms of Service</a
                    >
                    <a class="fz17 fw500 text-white mr15-md mr30" href="#"
                      >Privacy Policy</a
                  ...
                  <div class="footer-widget">
                    ...
                    <div class="app-widget mb-4 mb-sm-5">
                      ...
                      <div class="row mb-4 mb-lg-5">
                        <div class="col-lg-12">
                          <a
                            class="app-list d-flex align-items-center mb10"
                            href="#"
                          >
                          ...
                          <a
                            class="app-list d-flex align-items-center"
                            href="#"
                          >
  ...
  <script setup>
  // Optional: Add any JavaScript you need for the header
  </script>
