                                                    ...
                                                    <div class="tab-pane fade" id="primary-pills-profile" role="tabpanel">
                                                        ...
                                                        <div class="card">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <client-only placeholder="loading...">
                                                                            <ckeditor-nuxt v-model="insertdata.short_description" :config="editorConfig" class="form-control" />
                                                                        </client-only>
                                                                    </div>
                                                                </div>
                                                                <div class="row mb-3">
                                                                ...
                                                                <hr />
                                                                <div class="row mb-3 required">
                                                                    <label for="input-meta-title-1" class="col-sm-4 col-form-label">Shipping</label>
                                                                    <div class="col-sm-8">
                                                                        <select class="form-select form-select-sm" @change="shippingHandaller()" aria-label=".form-select-sm example" v-model="insertdata.free_shopping">
                                                                            <option selected>Select</option>
                                                                ...
                                                                <hr />                                                                
                                                                <div class="row mb-3 required">
                                                                    <label for="input-meta-title-1" class="col-sm-4 col-form-label">VAT/Tax </label>
                                                                    <div class="col-sm-4">
                                                                        <select class="form-select" @change="vathandaller()" aria-label=".form-select-sm example" v-model="insertdata.vat_status">
                                                                            <option selected>Select</option>
                                                                            <option value="1">Yes</option>
                                                                            <option value="0">No</option>
                                                                        </select>
                                                                ...
                                                                <div class="row mb-3 required">
                                                                    <label for="input-meta-title-1" class="col-sm-4 col-form-label vat_">Amount in percentage</label>
                                                                    <div class="col-sm-4">
                                                                        <input type="text" v-model="insertdata.vat" class="form-control vat_" @input="validateInput" />
                                                                    </div>
                                                                    <div class="col-sm-4 vat_">
                                                                        %
                                                                    </div>
                                                                </div>
                                                            </div>
