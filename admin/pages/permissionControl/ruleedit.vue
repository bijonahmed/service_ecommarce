                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">
                                    <LazyNuxtLink to="/permissionControl/roleManagement">Back to List</LazyNuxtLink>
                                </li>
...
const checkrow = () => {
    ...
    console.log("----" + id);
    axios.get(`/user/roleCheck/${id}`).then(response => {
...
const saveData = () => {
    ...
    axios.post('/user/saveRole', formData, { headers })
        .then((res) => {
            document.getElementById('formrest').reset();
            success_noti();
            router.push('/permissionControl/roleManagement');
        }).catch(error => {
