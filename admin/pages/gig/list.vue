                                ...
                                <div class="card-body">
                                    <div>
                                        ...
                                        <table class="table w-100 table-wrapper">
                                            <thead>
                                                <tr>
                                                    <th class="text-left">SellerID</th>
                                                    <th class="text-left">SellerName</th>
                                                    <th class="text-left">CategoryName</th>
                                                    <th class="text-left">GigTitle</th>
                                                    <th class="text-left">GigImag</th>
...
const fetchData = async (page) => {
    try {
        loading.value = true;
        const response = await axios.get(`/gig/getAllGigForAdmin`, {
            params: {
                page: page,
                pageSize: pageSize,
...
const deleteGig = async (id) => {
    ...
    if (confirmDelete) {
        try {
            const response = await axios.get(`/gig/deleteGigAdmin/${id}`);
            // Handle successful response
            Swal.fire('Deleted!', 'Your item has been deleted.', 'success');
            // Optionally, refresh your data or update your state
            filterData();
        } catch (error) {
