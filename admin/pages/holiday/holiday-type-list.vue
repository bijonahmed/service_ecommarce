    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    <div class="btn-group">
                        <Nuxt-link to="/holiday/holiday-add"><button type="button" class="btn btn-primary"><i class="bx bx-plus"></i>New</button></Nuxt-link>
                    </div>
                </div>
            </div>
            <!--end breadcrumb-->
...
export default {
    ...
    methods: {
        saveData() {
            ...
            this.$axios.post('/holiday/createEditHoliday',
                formData, {
                    headers
                }).then((res) => {
                $('#formrest')[0].reset();
        ...
        async fetchData() {
            ...
            try {
                ...
                const response = await this.$axios.get(`/holiday/getholidaylist`);
        ...
        edit(id) {
            $('#myModal').modal('show')
            this.$axios.get(`/holiday/chkholidayrow/${id}`).then(response => {
