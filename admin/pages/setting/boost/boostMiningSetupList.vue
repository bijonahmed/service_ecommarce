<template>
    <title>Boost Mining Setup List</title>
    <div>
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">
                                    <LazyNuxtLink to="/setting/boost/add">New</LazyNuxtLink>
                                </li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <table class="table w-100 table-wrapper">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">Lavel Cost</th>
                                                    <th class="text-center">Mining Per Seconds</th>
                                            ...
                                            <tbody>
                                                <tr v-for="item in productdata" :key="item.id">
                                                    ...
                                                    <td class="text-center">{{ item.level_cost }}</td>
                                                    <td class="text-center">{{ item.mining_per_seconds }}</td>
...
const selectedFilter = ref('01'); // Add a ref for the search query

const fetchData = async (page) => {
    try {
        loading.value = true;
        const response = await axios.get(`/setting/getBoostMiningList`, {
            params: {
                page: page,
                pageSize: pageSize,
