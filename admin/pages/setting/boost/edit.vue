                                        ...
                                        <div class="card-body">
                                            <div class="tab-content" id="custom-tabs-three-tabContent">
                                                <div class="tab-pane fade active show" id="custom-tabs-three-home"
                                                    ...
                                                    <div class="row mb-3 required">
                                                        <label for="input-name-1"
                                                            class="col-sm-3 col-form-label required-label">Mining Per
                                                            Seconds</label>
                                                        <div class="col-sm-9">
...
const defaultCallingRow = () => {
    ...
    axios.get(`/mining/boostminingrow/${id}`).then(response => {
        ...
        insertdata.mining_per_seconds = response.data.data.mining_per_seconds;
        insertdata.sort = response.data.data.sort;
...
const saveData = () => {
    ...
    axios.post("/mining/updateBotMining", formData, {
        headers: {
