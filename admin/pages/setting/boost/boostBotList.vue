                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">
                                    <LazyNuxtLink to="/setting/boost/addbot">New</LazyNuxtLink>
                                </li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <table class="table w-100 table-wrapper">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">Total Seconds</th>
                                            ...
                                            <tbody>
                                                <tr v-for="item in productdata" :key="item.id">
                                                    ...
                                                    <td class="text-center">{{ item.total_seconds }}</td>
...
const fetchData = async (page) => {
    try {
        loading.value = true;
        const response = await axios.get(`/setting/getBoostBotList`, {
            params: {
                page: page,
                pageSize: pageSize,
