                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Wedge Pay List</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="ms-auto">
                        <div class="btn-group">
                            <Nuxt-link to="/setting/wedges-pay-add"><button type="button" class="btn btn-primary"><i class="bx bx-plus"></i>New</button></Nuxt-link>
                        </div>
                    </div>
                </div>
                <!--end breadcrumb-->
    ...
    export default {
        ...
        methods: {
            saveData() {
                ...
                this.$axios.post('/setting/insertWedges',
                    formData, {
                        headers
                    }).then((res) => {
                    $('#formrest')[0].reset();
