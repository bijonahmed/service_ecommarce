                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item" aria-current="page">
                                    <router-link to="/setting/bank-short-code-list">Bank Short Code List</router-link>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">New Short Code</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <form @submit.prevent="saveData()" id="formrest" class="forms-sample" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            <label for="inputEnterYourName" class="col-sm-3 col-form-label">Code</label>
                                            <div class="col-sm-9">
