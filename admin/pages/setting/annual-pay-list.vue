                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Annual Pay List</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="ms-auto">
                        <div class="btn-group">
                            <Nuxt-link to="/setting/annual-pay-add"><button type="button" class="btn btn-primary"><i class="bx bx-plus"></i>New</button></Nuxt-link>
                        </div>
                    </div>
                </div>
                <!--end breadcrumb-->
    ...
    export default {
        ...
        methods: {
            saveData() {
                ...
                this.$axios.post('/setting/insertAnnualPay',
                    formData, {
                        headers
                    }).then((res) => {
                    $('#formrest')[0].reset();
            ...
            async fetchData() {
                ...
                try {
                    const response = await this.$axios.get(`/setting/getAnnualPayist`);
            ...
            edit(id) {
                $('#myModal').modal('show')
                this.$axios.get(`/setting/checkrowAnnualPay/${id}`).then(response => {
