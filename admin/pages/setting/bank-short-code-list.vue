                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Bank Short Code List</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="ms-auto">
                        <div class="btn-group">
                            <Nuxt-link to="/setting/bank-short-code-add"><button type="button" class="btn btn-primary"><i class="bx bx-plus"></i>New</button></Nuxt-link>
                        </div>
                    </div>
                </div>
                <!--end breadcrumb-->
                    ...
                    <div class="modal-body">
                        <div class="border p-4 rounded">
                            <form @submit.prevent="saveData()" id="formrest" class="forms-sample" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                            <label for="inputEnterYourName" class="col-sm-3 col-form-label">Bank</label>
                                            <div class="col-sm-9">
                                                <select name="bnak_id" v-model="insertdata.bnak_id" class="form-select">
                                                <option value="">Select</option>
                                                <option v-for='data in banklist' :value='data.id'>{{ data.name }}
                                                </option>
                                            </select>
    ...
    export default {
        ...
        methods: {
            ...
            saveData() {
                ...
                this.$axios.post('/setting/insertBankCode',
                    formData, {
                        headers
                    }).then((res) => {
                    $('#formrest')[0].reset();
