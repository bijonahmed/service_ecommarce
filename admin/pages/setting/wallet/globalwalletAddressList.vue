<template>
    <title>Global Wallet Address List</title>
    <div>
        <div class="content-wrapper">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <p>Global Wallet Address  List</p>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">
                                    <LazyNuxtLink to="/setting/wallet/addglobalwalletAddress">New Mining Duration</LazyNuxtLink>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-6 mb-2">
                                    <select v-model="selectedFilterLock" class="form-control" @change="filterData">
                                        <option value="">Lock/Unlock</option>
                                ...
                                <div class="card-body">
                                    <div>
                                        ...
                                        <table class="table w-100 table-wrapper">
                                            ...
                                            <tbody>
                                                <tr v-for="item in productdata" :key="item.id" :class="{'primary': item.lockunlock == 1, 'danger': item.lockunlock == 0}">
                                                    ...
                                                    <td class="text-center">{{ item.lock_unlock }}</td>
                                                    <td>
                                                        <center>
...
const fetchData = async (page) => {
    try {
        loading.value = true;
        const response = await axios.get(`/setting/getGlobalWalletAddress`, {
            params: {
                page: page,
                pageSize: pageSize,
...
const edit = (id) => {
    router.push({
        path: '/setting/wallet/globalwallet-edit',
        query: {
            parameter: id
        }
    });
