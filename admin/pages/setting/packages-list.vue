        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    ...
                    <!-- <div class="ms-auto">
                        <div class="btn-group">
                            <Nuxt-link to="/setting/add-salary"><button type="button" class="btn btn-primary"><i class="bx bx-plus"></i>New</button></Nuxt-link>
                        </div>
                    </div> -->
                </div>
                <!--end breadcrumb-->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="input-group mb-3">
                                    <Nuxt-link to="/setting/add-salary"><button type="button" class="btn btn-primary"><i
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-sm">
                                <thead>
                                    <tr>
                                        <th>Name</th>
                                        <th class="text-center">Number of Referell</th>
                                        <th class="text-center">Number of Sales</th>
                                        <th class="text-center">Number Blogs</th>
                                ...
                                <tbody>
                                    <tr v-for="item in paginatedData" :key="item.id">
                                        <td>{{ item.name }}</td>
                                        <td class="text-center">{{ item.number_of_referell }}</td>
                                        <td class="text-center">{{ item.number_of_sales }}</td>
                                        <td class="text-center">{{ item.number_of_blogs }}</td>
                                        <td class="text-center">{{ item.salary_amount }}</td>
                        ...
                        <div class="border p-4 rounded">
                            ...
                            <form @submit.prevent="saveData()" id="formrest" class="forms-sample"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control name" v-model="insertdata.number_of_referell"  
                                            placeholder="Name">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control name" v-model="insertdata.number_of_sales"  
                                            placeholder="Name">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control name" v-model="insertdata.number_of_blogs" id="name"
                                            placeholder="Name">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control name" v-model="insertdata.salary_amount" id="name"
                                            placeholder="Name">
                                        <span class="text-danger" v-if="errors.salary_amount">{{ errors.salary_amount[0] }}</span>
                                    </div>
                                </div>
...
export default {
    ...
    methods: {
        saveData() {
                ...
                this.$axios.post('/setting/insertPack',
                    formData, {
                        headers
                    }).then((res) => {
                    $('#formrest')[0].reset();
                    this.fetchData();
                    this.success_noti();
                    this.$router.push('/setting/packages-list');
        ...
        async fetchData() {
            ...
            try {
                const response = await this.$axios.get(`/setting/getPack`);
