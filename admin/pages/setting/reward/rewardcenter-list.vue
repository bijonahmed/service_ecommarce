<template>
    <title>Reward Center List</title>
    <div>
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">
                                    <LazyNuxtLink to="/setting/reward/add-rewardcenter">New</LazyNuxtLink>
                                </li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <table class="table w-100 table-wrapper">
                                            ...
                                            <tbody>
                                                <tr v-for="item in productdata" :key="item.id">
                                                    ...
                                                    <td class="text-left"><img v-if="item.thumnail_img" :src="item.thumnail_img" class="img-thumbnail" alt="Image" style="height:50px; width: 100%;"></td>
...
const fetchData = async (page) => {
    try {
        loading.value = true;
        const response = await axios.get(`/reward/rewardCenterList`, {
            params: {
                page: page,
                pageSize: pageSize,
...
const edit = (id) => {
    ...
    router.push({
        path: '/setting/reward/edit-rewardcenter',
        query: {
            parameter: id
        }
    });
