<template>
    <title>Add Reward Center List</title>
    <div>
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">
                                    <LazyNuxtLink to="/setting/reward/rewardcenter-list">Back to List</LazyNuxtLink>
                                </li>
                            </ol>
                        </div>
                    </div>
...
const saveData = () => {
    ...
    axios.post('/reward/insertrward', formData, {
        headers: {
        ...
        router.push({
            path: '/setting/reward/rewardcenter-list',
        });
