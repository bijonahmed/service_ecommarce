        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4">
            <div class="col">
                <div class="card radius-10 bg-gradient-deepblue">
                    <Nuxt-link to="/leave/leave-type-list">
                        <div class="card-body">
            ...
            <div class="col">
                <div class="card radius-10 bg-gradient-orange">
                    <Nuxt-link to="/leave/leave-role-list">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="d-flex align-items-center text-white">
            ...
            <div class="col">
                <div class="card radius-10 bg-gradient-ohhappiness">
                    <Nuxt-link to="/leave/allocation-list">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="d-flex align-items-center text-white">
                                    <p class="mb-0">Leave Allocation
                                    </p>
            ...
            <div class="col">
                <div class="card radius-10 bg-gradient-ibiza">
                    <Nuxt-link to="/leave/leave-balance-list">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="d-flex align-items-center text-white">
            ...
            <div class="col">
                <div class="card radius-10 bg-gradient-ibiza">
                    <Nuxt-link to="/leave/leave-report">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="d-flex align-items-center text-white">
                                    <p class="mb-0">Leave Report</p>
                                </div>
                                <div class="ms-auto">
                                    <i class='bx bx-envelope fs-3 text-white'></i>
                                </div>
