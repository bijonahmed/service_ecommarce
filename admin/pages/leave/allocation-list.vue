                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Leave Allocation List </li>
                            </ol>
                        </nav>
                    </div>
                    <div class="ms-auto">
                        <div class="btn-group">
                            <Nuxt-link to="/leave/add-allocation"><button type="button" class="btn btn-primary"><i class="bx bx-plus"></i>New</button></Nuxt-link>
                        </div>
                    </div>
                </div>
                <!--end breadcrumb-->
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control emp_name" placeholder="Employee Name" v-model="searchQuery.name" @input="handleSearch">
                                </div>
                            </div>
                            ...
                            <table class="table table-hover table-sm">
                                ...
                                <tbody>
                                    <tr v-for="item in paginatedData" :key="item.id">
                                        ...
                                        <td>{{ item.emp_name }}</td>
                                        <td>{{ item.maximum_no_annual }}</td>
                                        <td>{{ item.leave_in_hand }}</td>
                                        <td>{{ item.effective_year }}</td>

                                        <td>
                                            <center>
                                                <nuxt-link :to="{name: 'leave-edit-leaveallocation-id', params: {id: item.id}}" variant="warning" size="sm"><i class="bx bx-edit"></i>EDIT
                                                        </nuxt-link> 
                                            </center>
                                        </td>
                                    </tr>
