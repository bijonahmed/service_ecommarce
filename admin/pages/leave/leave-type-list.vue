        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    ...
                    <div class="ms-auto">
                        <div class="btn-group">
                            <Nuxt-link to="/leave/add-leavetype"><button type="button" class="btn btn-primary"><i class="bx bx-plus"></i>New</button></Nuxt-link>
                        </div>
                    </div>
                </div>
                <!--end breadcrumb-->
                            ...
                            <table class="table table-hover table-sm">
                                ...
                                <tbody>
                                    <tr v-for="item in paginatedData" :key="item.id">
                                        ...
                                        <td>
                                            <center>
                                                <nuxt-link :to="{name: 'leave-edit-leavetype-id', params: {id: item.id}}" variant="warning" size="sm"><i class="bx bx-edit"></i>EDIT
                                                        </nuxt-link> 
                                            </center>
                                        </td>
                                    </tr>
    ...
    export default {
        ...
        methods: {
            async fetchData() {
                ...
                try {
                    const response = await this.$axios.get(`/leave/getLeaveTypeList`);
