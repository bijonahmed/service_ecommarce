                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">New Circumstances</li>
                        </ol>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="border p-4 rounded">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <select name="employe_id" v-model="insertdata.employe_id" class="form-select employe_id" @change="getEmployee()">
                                            <option value="">Select</option>
                                            <option v-for='data in emplist' :value='data.id'>{{ data.name }} [{{ data.employee_code }}]
                                            </option>
                                        </select>
                                ...
                                <div style="display: none;" class="show_loader">
                                ...
                                <form @submit.prevent="saveData()" id="formrest" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" readonly class="form-control employee_code" v-model="insertdata.employee_code" id="employee_code" placeholder="Employee Code">
                                            <span class="text-danger" v-if="errors.employee_code">{{ errors.employee_code[0] }}</span>
                                        </div>
                                        <div class="form-group col-md-4">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <button type="submit" id="btn_submit" class="btn btn-success px-5 w-100"><i class="bx bx-check-circle mr-1"></i> Submit</button>
                                        </div>
                                    </div>
                                </form>
...
export default {
    ...
    methods: {
        ...
        saveData() {
            ...
            this.$axios.post('/user/saveCircumstances',
                formData, {
                    headers
                }).then((res) => {
                $('#formrest')[0].reset();
