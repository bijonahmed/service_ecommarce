    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto">
                    <div class="btn-group">
                        <Nuxt-link to="/employee/designation-add"><button type="button" class="btn btn-primary"><i class="bx bx-plus"></i>New</button></Nuxt-link>
                    </div>
                </div>
            </div>
            <!--end breadcrumb-->
...
export default {
    ...
    methods: {
        saveData() {
            ...
            this.$axios.post('/user/saveDesignation',
                formData, {
                    headers
                }).then((res) => {
                $('#formrest')[0].reset();
