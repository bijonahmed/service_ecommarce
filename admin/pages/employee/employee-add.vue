                            ...
                            <div class="border p-4 rounded">
                                ...
                                <form @submit.prevent="saveData()" id="formrest" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="inputPassword4">Upload Documentlabel</label>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control employee_code" v-model="insertdata.nid_number" id="employee_code">
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="inputEmail4"> <input type="checkbox" name="payment_da" v-model="insertdata.payment_da" value="1"></label>
                                            Dearness Allowance
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="inputEmail4"><input type="checkbox" name="hra" value="2" v-model="insertdata.ni_dedu_hra"></label>
                                            I. Tax Deduction
                                        </div>

                                        <div class="form-group col-md-3">
                                            <label for="inputPassword4"><input type="checkbox" name="conven_ta" value="3" v-model="insertdata.ni_dedu_conven_ta"></label>
                                            I. Tax Cess

                                        </div>

                                        <div class="form-group col-md-3">
                                            <label for="inputPassword4"><input type="checkbox" name="perfomance" value="4" v-model="insertdata.ni_dedu_perfomance"></label>ESI
                                        </div>

                                        <div class="form-group col-md-3">
                                            <label for="inputPassword4"><input type="checkbox" name="monthly_al" value="5" v-model="insertdata.ni_dedu_monthly_al"></label>Prof Tax
                                        </div>
