                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Assign To User</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="border p-4 rounded">
                                ...
                                <form @submit.prevent="saveData()" id="formrest" class="forms-sample" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputpassword_confirmation2" class="col-sm-3 col-form-label">Select Employee</label>
                                        <div class="col-sm-9">

                                            <select name="employee_id" v-model="insertdata.employee_id" class="form-select employee_id" @change="getEmployeeDetails">
                                                <option value="" selected>Select</option>
                                                <option v-for='data in allEmploye' :value='data.id'>{{data.name}}</option>
                                            </select>
...
export default {
    ...
    methods: {
        ...
        saveData() {
            ...
            this.$axios.post('/user/assignToUser',
                formData, {
                    headers
                }).then((res) => {
                $('#formrest')[0].reset();
