...
// CONCATENATED MODULE: ./pages/seller/seller-products-post.vue?vue&type=template&id=339d9079&
...
var seller_products_postvue_type_script_lang_js_ = __webpack_require__(91);
...
/* harmony import */ var _components_Common_MobileSidebar_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(54);
/* harmony import */ var _components_Common_MiniTabNavbar_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(55);
/* harmony import */ var _components_Common_MobileSearchProduct_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(67);
/* harmony import */ var _pages_seller_seller_leftsidebar_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(72);
/* harmony import */ var _components_NavbarSecond_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(66);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  middleware: 'IsSeller',
  components: {
    NavbarSecond: _components_NavbarSecond_vue__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"],
  ...
  methods: {
    ...
    checkImageDimensions(file) {
      // Ensure this.images is initialized
      if (!Array.isArray(this.images)) {
        this.images = [];
      }
      // Debugging log to check the current image count
      console.log("Current images count: " + this.images.length);
      // Pre-check to prevent file processing if limit already reached
      ...
      reader.onload = e => {
        ...
        img.onload = () => {
          // Check if image dimensions are 300x300
          if (img.width === 300 && img.height === 300) {
            // Check again inside the img.onload before pushing
            if (this.images.length < 3) {
              ...
              // Debugging log to check image push success
              console.log('Image added successfully. New count: ' + this.images.length);
            } else {
              alert('You can only upload up to 3 images.');
              this.$refs.images.value = ''; // Reset file input
            }
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(36)["URL"]))
