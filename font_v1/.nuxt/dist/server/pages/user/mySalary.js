...
module.exports.__inject__ = function (context) {
  add("640c6796", content, true, context)
};
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_mySalary_vue_vue_type_style_index_0_id_2a4125a7_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(120);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_mySalary_vue_vue_type_style_index_0_id_2a4125a7_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_mySalary_vue_vue_type_style_index_0_id_2a4125a7_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_mySalary_vue_vue_type_style_index_0_id_2a4125a7_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_mySalary_vue_vue_type_style_index_0_id_2a4125a7_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".loading-indicator[data-v-2a4125a7]{background-color:hsla(0,0%,100%,.8);height:100%;left:0;position:fixed;top:0;width:100%;z-index:9999}.loader-container[data-v-2a4125a7],.loading-indicator[data-v-2a4125a7]{align-items:center;display:flex;justify-content:center}.loader-container[data-v-2a4125a7]{flex-direction:column;height:100vh;position:relative}.loader-text[data-v-2a4125a7]{margin:0}.loader-top[data-v-2a4125a7]{top:0}.loader-bottom[data-v-2a4125a7]{bottom:0}.pricing-table[data-v-2a4125a7]{background:linear-gradient(135deg,#6a11cb,#2575fc);border-radius:12px;box-shadow:0 8px 20px rgba(0,0,0,.15);color:#fff;margin:20px auto;max-width:300px;padding:30px;text-align:center;transition:transform .3s ease}.pricing-table[data-v-2a4125a7]:hover{transform:translateY(-10px)}.pricing-table h2[data-v-2a4125a7]{color:#fff;font-size:1.8rem;font-weight:700}.pricing-features[data-v-2a4125a7],.pricing-table h2[data-v-2a4125a7]{margin-bottom:20px}.feature[data-v-2a4125a7]{background-color:hsla(0,0%,100%,.2);border-radius:8px;display:flex;font-size:1.1rem;justify-content:space-between;margin:10px 0;padding:10px 15px}.feature span[data-v-2a4125a7]{font-weight:700}.price-tag[data-v-2a4125a7]{align-items:baseline;display:flex;font-size:2.5rem;justify-content:center;margin-top:20px}.symbol[data-v-2a4125a7]{font-size:1.5rem;margin-right:5px}.amount[data-v-2a4125a7]{font-size:3rem;font-weight:700}.after[data-v-2a4125a7]{color:#ddd;font-size:1rem;margin-left:5px}.purple[data-v-2a4125a7]{background:linear-gradient(135deg,#7b1fa2,#ab47bc)}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/user/mySalary.vue?vue&type=template&id=2a4125a7&scoped=true&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('LogoAndPayment'), _vm._ssrNode(" "), _c('NavbarSecond'), _vm._ssrNode(" "), _vm._ssrNode("<section class=\"main_content\" data-v-2a4125a7>", "</section>", [_vm._ssrNode("<div class=\"container-fluid\" data-v-2a4125a7>", "</div>", [_vm._ssrNode("<div class=\"row\" data-v-2a4125a7>", "</div>", [_vm._ssrNode("<div class=\"col-md-3\" data-v-2a4125a7>", "</div>", [_c('userSidebar')], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-md-9 ps-md-0 col-12\" data-v-2a4125a7>", "</div>", [_vm.loading ? _vm._ssrNode("<div class=\"loading-indicator\" data-v-2a4125a7>", "</div>", [_vm._ssrNode("<div class=\"loader-container\" data-v-2a4125a7>", "</div>", [_c('center', {
    staticClass: "loader-text"
  }, [_vm._v("Loading...")]), _vm._ssrNode(" <img src=\"/loader/loader.gif\" alt=\"Loader\" data-v-2a4125a7>")], 2)]) : _vm._e(), _vm._ssrNode(" <div class=\"container\" data-v-2a4125a7><br data-v-2a4125a7><br data-v-2a4125a7> <div class=\"row\" data-v-2a4125a7>" + _vm._ssrList(_vm.salaryall, function (data) {
    return "<div class=\"col-md-4\" data-v-2a4125a7><div class=\"pricing-table purple\" data-v-2a4125a7><h2 data-v-2a4125a7>" + _vm._ssrEscape(_vm._s(data.name)) + "</h2> <div class=\"pricing-features\" data-v-2a4125a7><div class=\"feature\" data-v-2a4125a7>Number of Referrals<span data-v-2a4125a7>" + _vm._ssrEscape(_vm._s(data.number_of_referell)) + "</span></div> <div class=\"feature\" data-v-2a4125a7>Number of Sales<span data-v-2a4125a7>" + _vm._ssrEscape(_vm._s(data.number_of_sales)) + "</span></div> <div class=\"feature\" data-v-2a4125a7>Number of Blogs<span data-v-2a4125a7>" + _vm._ssrEscape(_vm._s(data.number_of_blogs)) + "</span></div></div> <div class=\"price-tag\" data-v-2a4125a7><span class=\"symbol\" data-v-2a4125a7>$</span> <span class=\"amount\" data-v-2a4125a7>" + _vm._ssrEscape(_vm._s(data.salary_amount)) + "</span> <span class=\"after\" data-v-2a4125a7>/Salary</span></div></div></div>";
  }) + "</div></div>")], 2)], 2)])]), _vm._ssrNode(" <div class=\"back_top\" data-v-2a4125a7><a href=\"#top\" data-v-2a4125a7><i class=\"fa-solid fa-angle-up\" data-v-2a4125a7></i></a></div> "), _c('Footer')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/user/mySalary.vue?vue&type=template&id=2a4125a7&scoped=true&
...
/* harmony default export */ var mySalaryvue_type_script_lang_js_ = ({
  middleware: 'IsUser',
  components: {
...
// CONCATENATED MODULE: ./pages/user/mySalary.vue?vue&type=script&lang=js&
 /* harmony default export */ var user_mySalaryvue_type_script_lang_js_ = (mySalaryvue_type_script_lang_js_); 
...
var component = Object(componentNormalizer["a" /* default */])(
  user_mySalaryvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
