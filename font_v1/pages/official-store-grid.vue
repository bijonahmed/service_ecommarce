                    ...
                    <div class="store_details">
                        <div class="row">
                            <div class="col-sm-3 text-center m-auto justify-content-center">
                                <div class="img_box">
                                    <img src="/images/addidas1.jpg" class="img-fluid" alt="">
                                </div>
                                <div class="ratings">
                            ...
                            <div class="col-sm-9">
                                <div class="store_information">
                                    <ul>
                                        <li>
                                            <a href="#"><i class="fa-solid fa-location-dot"></i> school road, wireless,
                                                Mohakhali, Dhaka </a>
                                        </li>
                                        <li>
                                            <a href="#"><i class="fa-solid fa-phone"></i> 444364434414</a>
                                        </li>
                                        <li>
                                            <a href="#"><i class="fa-regular fa-envelope"></i> school road, wireless,
                                                Mohakhali, Dhaka </a>
                                        </li>
                                    </ul>
                                </div>
...
import PhoneDeals from '~/components/PhoneDeals.vue';
import OfficialStoreFilterGrid from '~/pages/OfficialStoreFilterGrid.vue';
