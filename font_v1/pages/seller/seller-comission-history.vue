                    ...
                    <div class="col-md-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-6">
                                        <button type="button" class="btn_cart"
                                            style="visibility: unset; color: #fff; width: fit-content;"
                        ...
                        <div class="main_profile">
                            <div class="user_details order_details_table">
                                        ...
                                        <tr v-for="(product, index) in products" :key="index">
                                            ...
                                            <td>
                                                <center>
                                                    ...
                                                    <span><button type="button" class="btn_edit_nxt"
                                                            @click="orderDetails(product.orderId)"><i
                                                                class="fa-solid fa-magnifying-glass-plus"></i></button></span>
                                                </center>
                                            </td>
                                        </tr>
                                ...
                                <!-- pagination -->
                                <center>
                                    <button class="btn_cart" style="visibility: unset; color: #fff; width: fit-content;"
